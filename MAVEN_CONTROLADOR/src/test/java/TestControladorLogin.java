...
public class TestControladorLogin {
	...
	public void setUp() throws Exception {
		...
		when(event.getActionCommand()).thenReturn(Constantes.LOGIN);
	}
	...
	public void testLogin() {
		...
		Assert.assertEquals("Error al loguearse",this.ussername,this.empresa.getUsuarioLogeado().getNombreUsuario());
		}
