...
public class TestUtilPersistencia {
    ...
    public void testEmpresaDtoFromEmpresaCheckNombreChoferesDesoc() {
		ArrayList<Chofer> choferesDesocupadosObtenidos = Empresa.getInstance().getChoferesDesocupados();
    ...
    public void testEmpresaDtoFromEmpresaCheckPatenteVehiculos() {
		HashMap<String, Vehiculo> vehiculosObtenidos = Empresa.getInstance().getVehiculos();
    ...
    public void testEmpresaDtoFromEmpresaCheckPatenteVehiculosDesoc() {
		ArrayList<Vehiculo> vehiculosDesocupadosObtenidos = Empresa.getInstance().getVehiculosDesocupados();
    ...
    public void testEmpresaDtoFromEmpresaCheckCantPasViajesIni() {
		HashMap<Cliente, Viaje> viajesIniciadosObtenidos = Empresa.getInstance().getViajesIniciados();
    ...
    public void testEmpresaDtoFromEmpresaCheckCantPasViajesTerm() {
		ArrayList<Viaje> viajesTerminados = Empresa.getInstance().getViajesTerminados();
