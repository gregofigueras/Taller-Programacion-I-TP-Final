...
public class TestEmpresaCrearViajeVehiculoNoValidoException {
	...
	@Test
	public void testCrearViajeVehiculoNoValidoException() {
		try {
			this.empresa.crearViaje(this.pedido, this.chofer, this.auto);
			fail("No se lanzo VehiculoNoValidoException");
