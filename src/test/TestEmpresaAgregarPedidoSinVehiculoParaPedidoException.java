...
public class TestEmpresaAgregarPedidoSinVehiculoParaPedidoException {
	...
	@Test
	public void testEmpresaAgregarPedidoSinVehiculoParaPedidoException() {
		try {
			empresa.agregarPedido(this.pedido);
			fail("Deberia haber lanzado SinVehiculoParaPedidoException");
