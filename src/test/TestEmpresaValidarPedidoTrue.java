...
public class TestEmpresaValidarPedidoTrue {
	...
	@Test
	public void testValidarPedidosTrue() {
		Assert.assertTrue("Validar pedido funciona erroneamente en true", this.empresa.validarPedido(this.pedido));
	}
