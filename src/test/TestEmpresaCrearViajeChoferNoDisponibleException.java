...
public class TestEmpresaCrearViajeChoferNoDisponibleException {
	...
	@Test
	public void testCrearViajeChoferNoDisponibleException() {
		try {
			this.empresa.crearViaje(this.pedido, this.chofer, this.auto);
			fail("No se lanzo ChoferNoDisponibleException");
