...
public class TestEmpresaAgregarPedidoClienteConPedidoPendienteException {
	...
	@Test
	public void testAgregarPedidoClienteConPedidoPendienteException() {
		try {
			empresa.agregarPedido(this.pedido);
			empresa.agregarPedido(this.pedido2);
			fail("Deberia haber lanzado ClienteConPedidoPendienteException");
