...
public class TestUtilPersistenciaDTOFromEmpresa {
    ...
    public void testEmpresaDtoFromEmpresaCheckUsuarioClientes() {
		HashMap<String, Cliente> clientesObtenidos =  empresaDTO.getClientes();
    ...
    public void testEmpresaDtoFromEmpresaCheckDniChoferes() {
		HashMap<String, Chofer> choferesObtenidos = empresaDTO.getChoferes();
    ...
    public void testEmpresaDtoFromEmpresaCheckCantPasPedidos() {
		HashMap<Cliente, Pedido> pedidosObtenidos = empresaDTO.getPedidos();
    ...
    public void testEmpresaDtoFromEmpresaCheckNombreChoferesDesoc() {
		ArrayList<Chofer> choferesDesocupadosObtenidos = empresaDTO.getChoferesDesocupados();
    ...
    public void testEmpresaDtoFromEmpresaCheckPatenteVehiculos() {
		HashMap<String, Vehiculo> vehiculosObtenidos = empresaDTO.getVehiculos();
    ...
    public void testEmpresaDtoFromEmpresaCheckPatenteVehiculosDesoc() {
		ArrayList<Vehiculo> vehiculosDesocupadosObtenidos = empresaDTO.getVehiculosDesocupados();
    ...
    public void testEmpresaDtoFromEmpresaCheckCantPasViajesIni() {
		HashMap<Cliente, Viaje> viajesIniciadosObtenidos = empresaDTO.getViajesIniciados();
    ...
    public void testEmpresaDtoFromEmpresaCheckCantPasViajesTerm() {
		ArrayList<Viaje> viajesTerminados = empresaDTO.getViajesTerminados();
